...
@Component
public class JobSearchCriteria implements JobsFilterCriteria{
    ...
    public List<JobDto> meetCriteria(String data){
        ...
        List<Job> jobs = jobRepository.findAllByTitleContainsOrCompany_NameContainsIgnoreCase(data, data).orElse(new ArrayList<>());
